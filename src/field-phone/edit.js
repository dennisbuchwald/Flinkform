...
export default function Edit( { attributes, setAttributes, context, clientId } ) {
	...
	const blockProps = useBlockProps( { className: 'flinkform-field flinkform-field--phone' } );

	useEffect( () => {
		if ( ! fieldName ) {
			setAttributes( { fieldName: generateFieldName( 'phone' ) } );
		}
